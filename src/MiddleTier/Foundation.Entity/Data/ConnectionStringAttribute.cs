//-----------------------------------------------------------------------
// <copyright file="ConnectionStringAttribute.cs" company="Genesys Source">
...
namespace Genesys.Foundation.Data
{
    ...
    public class ConnectionStringAttribute : Attribute, IAttributeValue<string>
    {
        /// <summary>
        /// Name supplied by attribute.
        /// Default is MyDataConnection
        /// </summary>
        public string Value { get; set; } = "MyDataConnection";
