...
namespace Genesys.Foundation.Test
{
    ...
    public class ProcessTests
    {
        ...
        public void Process_SessionContextKnownType()
        {
            ...
            ISerializer<ProcessParameter<NameIDModel>> serializer2 = new JsonSerializer<ProcessParameter<NameIDModel>>();
        ...
        /// <summary> 
        /// Process_ProcessParameterSerialize
        /// </summary>
        /// <remarks></remarks>
        [TestMethod()]
        public void Process_ProcessParameterSerialize()
        {
            ...
            dataToSendSerialized = serializer.Serialize(item2);
            Assert.IsTrue(dataToSendSerialized != TypeExtension.DefaultString, "Did not work");
            item2 = serializer.Deserialize(dataToSendSerialized);
            Assert.IsTrue(item2 != null, "Did not work.");
        }
